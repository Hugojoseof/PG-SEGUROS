        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            ...
            <div className="flex items-center justify-center mb-8">
              ...
              <p className="text-xl text-slate-600 font-medium">
                Mais de 2.5k seguidores confiam em nossas dicas
              </p>
            ...
            {loading ? (
              ...
              Array.from({ length: 4 }).map((_, index) => (
                <Card key={index} className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
                  <CardContent className="p-0 overflow-hidden">
                    <div className="relative">
                      <div className="w-full h-64 bg-gradient-to-br from-slate-200 to-slate-300 animate-pulse"></div>
                      <div className="p-5">
              ...
              posts.map((post, index) => {
                ...
                return (
                  <Card 
                    key={post.id} 
                    className="group border-0 shadow-xl hover:shadow-3xl transition-all duration-700 hover:-translate-y-4 cursor-pointer bg-white/90 backdrop-blur-sm rounded-2xl overflow-hidden"
                      ...
                      <div className="relative">
                        ...
                        <div className="relative overflow-hidden">
                          <img
                            src={post.media_url}
                            alt="Instagram post"
                            className="w-full h-72 object-cover group-hover:scale-105 transition-transform duration-1000 ease-out"
                            onError={(e) => {
                        ...
                        <div className="p-4">
                          <div className="flex items-center justify-center">
                            <div className="flex items-center text-purple-600 group-hover:text-purple-700 transition-colors">
                              <span className="text-sm font-medium mr-2">Ver no Instagram</span>
          ...
          <div className="text-center mb-20">
            <div className="relative overflow-hidden rounded-3xl">
              ...
              <div className="absolute inset-0">
                ...
                <div className="absolute bottom-0 right-0 w-72 h-72 bg-white/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
              </div>
              ...
              <div className="relative p-12 text-white">
                <div className="max-w-2xl mx-auto">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <Button
                      size="lg"
                      onClick={() => window.open("https://instagram.com/pg.seguros", "_blank")}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <div key={index} className={`${platform.bgColor} rounded-2xl p-8 text-center group hover:scale-105 transition-all duration-300 cursor-pointer`}>
                ...
                <h4 className="font-bold text-slate-800 mb-2 text-lg">{platform.name}</h4>
                <p className="text-3xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent mb-1">
                  {platform.count}
                </p>
                <p className="text-sm text-slate-600 font-medium">{platform.label}</p>
              </div>
            ))}
          </div>
        </div>
